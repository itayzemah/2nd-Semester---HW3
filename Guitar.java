...
public class Guitar extends StringInstrument  {
	...
	public void stringsCheck(int numOfStrings) {
		switch (indexOfType()){
            case CLASSIC:
    ...
    @Override
    public Guitar clone(){
    	return new Guitar(this.getBrand(), (double)this.getPrice(), this.getNumOfStrings(),this.getType());
    }
